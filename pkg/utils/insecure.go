...
func loadServerTLSCredentials(certPEM, keyPEM string) (credentials.TransportCredentials, error) {
...
func loadClientTLSCredentials(caCert string) (credentials.TransportCredentials, error) {
