...
func request_ServiceExtra_Login_0(ctx context.Context, marshaler runtime.Marshaler, client ServiceExtraClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_ServiceExtra_Login_0(ctx context.Context, marshaler runtime.Marshaler, server ServiceExtraServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq LoginRequest
	var metadata runtime.ServerMetadata
...
func RegisterServiceExtraHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ServiceExtraServer) error {
	...
	mux.Handle("POST", pattern_ServiceExtra_Login_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ServiceExtra_Login_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_ServiceExtra_Login_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterServiceExtraHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ServiceExtraClient) error {
	...
	mux.Handle("POST", pattern_ServiceExtra_Login_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ServiceExtra_Login_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_ServiceExtra_Login_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v2", "extra", "login"}, "", runtime.AssumeColonVerbOpt(true)))
...
var (
	forward_ServiceExtra_Login_0 = runtime.ForwardResponseMessage
